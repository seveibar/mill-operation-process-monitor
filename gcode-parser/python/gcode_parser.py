...
def _initialization( curCommandInt, time, xPos, yPos, zPos, commandList, XYZ, timeXYZRecord):
...
def _movementGCode( curCommandInt, time, xPos, yPos, zPos, feedRate, commandList, XYZ, timeXYZRecord):
	oldXPos = xPos
	oldYPos = yPos
	oldZPos = zPos
...
def parse(filename, output_file=None, graph=False):
	...
	feedRate, measurementUnits, curCommandInt, xPos, yPos, zPos = _initialization( curCommandInt, time, xPos, yPos, zPos, commandList, XYZ, timeXYZRecord)
	while( curCommandInt < len( commandList ) ):
		...
		if( curCommandInt >= len( commandList ) ):
			break
		curCommandInt, xPos, yPos, zPos, time = _movementGCode( curCommandInt, time, xPos, yPos, zPos, feedRate, commandList, XYZ, timeXYZRecord)
...
if __name__ == "__main__":
	...
	parse(filename, output_file=output_file)
